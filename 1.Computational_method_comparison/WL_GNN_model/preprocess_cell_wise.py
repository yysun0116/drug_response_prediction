...
def create_datasets(file_dir, radius, device):
    ...
    def create_dataset(filename):
        ...
        for data in data_original:
            ...
            smiles, property, cell_line = data.strip().split()
            ...
            dataset.append((fingerprints, adjacency, molecular_size, property, cell_line))

        return dataset



    dataset_train = create_dataset('prism_train_long.txt')
    #dataset_train, dataset_dev = split_dataset(dataset_train, 0.9)
    dataset_test = create_dataset('prism_test_long.txt')

    
    #dataset_processed = create_dataset('data_train.txt')
    #dataset_processed = create_dataset('PRISM_clean_interCCLE.txt')
