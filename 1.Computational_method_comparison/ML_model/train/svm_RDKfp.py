...
print("training svm model on %d cell lines" %(len(cell_line_ls)))
...
result_df.to_csv(os.path.join(datadir, "drug_sensitivity_prediction/1.Computational_method_comparison/ML_model/cell_line_eval/svm_RDKfp_result.csv"), index=True)
print("Done!")
