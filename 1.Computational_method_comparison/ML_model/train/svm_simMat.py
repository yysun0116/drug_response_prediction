...
result_df.to_csv(os.path.join(datadir, "drug_sensitivity_prediction/1.Computational_method_comparison/ML_model/cell_line_eval/svm_simMat_result.csv"), index=True)
print("Done!")
